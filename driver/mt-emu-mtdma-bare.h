...
#define REG_DMA_COMM_WR_MRG_R_STS_0   (REG_DMA_CHAN_BASE + 0xC30)
#define REG_DMA_COMM_WR_MRG_R_STS_1   (REG_DMA_CHAN_BASE + 0xC34)
#define REG_DMA_COMM_WR_MRG_R_STS_2   (REG_DMA_CHAN_BASE + 0xC38)
#define REG_DMA_COMM_WR_MRG_R_STS_3   (REG_DMA_CHAN_BASE + 0xC3c)

#define REG_DMA_COMM_WR_MRG_W_STS_0   (REG_DMA_CHAN_BASE + 0xC50)
#define REG_DMA_COMM_WR_MRG_W_STS_1   (REG_DMA_CHAN_BASE + 0xC54)
#define REG_DMA_COMM_WR_MRG_W_STS_2   (REG_DMA_CHAN_BASE + 0xC58)
#define REG_DMA_COMM_WR_MRG_W_STS_3   (REG_DMA_CHAN_BASE + 0xC5c)
/* Common Reg Addr */
...
#define REG_DMA_COMM_RD_MRG_PF0_IMSK_L  (0xC20)
#define REG_DMA_COMM_RD_MRG_PF0_IMSK_H  (0xC24)
#define REG_DMA_COMM_RD_MRG_PF0_STS_L   (0xC28)
#define REG_DMA_COMM_RD_MRG_PF0_STS_H   (0xC2C)
#define REG_DMA_COMM_WR_MRG_PF0_IMSK_L  (0xC30)
#define REG_DMA_COMM_WR_MRG_PF0_IMSK_H  (0xC34)
#define REG_DMA_COMM_WR_MRG_PF0_STS_L   (0xC38)
#define REG_DMA_COMM_WR_MRG_PF0_STS_H   (0xC3C)
#define REG_DMA_COMM_MRG_PF0_STS        (0xC40)
...
#define REG_DMA_COMM_WORK_STS           (0xE00)
/* CH Reg Addr */
